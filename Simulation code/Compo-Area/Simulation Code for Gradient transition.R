...
#### Setting for first homo sub-region
set.seed(81)
N_s<-6
T<-4
...
cat("Dominant type has",N_s,"cells,","specifically type",types,",first is dominant")
for (m in 301:340) {
  Dominant<-rCMP(n=1,mu = 5,nu=20,x_max =7)
  sub1<-rCMP(n=1,mu = 0.10,nu=2.3,x_max =2)
  sub2<-rCMP(n=1,mu = 1,nu=20,x_max =3)
  sub3<-rCMP(n=1,mu = 0.10,nu=2.3,x_max =2)
  cell_pertype<-c(Dominant,sub1,sub2,sub3)
  spot_num<-sum(cell_pertype)
  spot_types<-types
...
for (m in 341:380) {
  Dominant<-rCMP(n=1,mu = 4,nu=20,x_max =6)
  sub1<-rCMP(n=1,mu = 0.10,nu=2.3,x_max =2)
  sub2<-rCMP(n=1,mu = 2,nu=20,x_max =4)
  sub3<-rCMP(n=1,mu = 0.10,nu=2.3,x_max =2)
  cell_pertype<-c(Dominant,sub1,sub2,sub3)
  spot_num<-sum(cell_pertype)
  spot_types<-types
...
for (m in 381:420) {
  Dominant<-rCMP(n=1,mu = 3,nu=20,x_max =5)
  sub1<-rCMP(n=1,mu = 0.10,nu=2.3,x_max =2)
  sub2<-rCMP(n=1,mu = 3,nu=20,x_max =5)
  sub3<-rCMP(n=1,mu = 0.10,nu=2.3,x_max =2)
  cell_pertype<-c(Dominant,sub1,sub2,sub3)
  spot_num<-sum(cell_pertype)
  spot_types<-types
...
for (m in 421:460) {
  Dominant<-rCMP(n=1,mu = 2,nu=20,x_max =4)
  sub1<-rCMP(n=1,mu = 0.10,nu=2.3,x_max =2)
  sub2<-rCMP(n=1,mu = 4,nu=20,x_max =6)
  sub3<-rCMP(n=1,mu = 0.10,nu=2.3,x_max =2)
  cell_pertype<-c(Dominant,sub1,sub2,sub3)
  spot_num<-sum(cell_pertype)
  spot_types<-types
...
for (m in 461:500) {
  Dominant<-rCMP(n=1,mu = 1,nu=20,x_max =3)
  sub1<-rCMP(n=1,mu = 0.10,nu=2.3,x_max =2)
  sub2<-rCMP(n=1,mu = 5,nu=20,x_max =7)
  sub3<-rCMP(n=1,mu = 0.10,nu=2.3,x_max =2)
  cell_pertype<-c(Dominant,sub1,sub2,sub3)
  spot_num<-sum(cell_pertype)
  spot_types<-types
